...
class MessageModel {
  ...
  factory MessageModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return MessageModel(
      ...
      // Extracting the Conversation ID from the Reference
      conversationId: (data['conversation_id'] as DocumentReference).id,
      isRead: data['is_read'] ?? false,
      messageType: data['message_type'] ?? 'text',
      // Extracting the Sender ID from the Reference
      senderId: (data['sender_id'] as DocumentReference).id,
  ...
  Map<String, dynamic> toMap() {
    return {
      'content': content,
      'conversation_id': FirebaseFirestore.instance.doc('Conversation/$conversationId'),
      'is_read': isRead,
